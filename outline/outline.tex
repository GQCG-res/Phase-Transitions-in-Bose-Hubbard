...
\end{equation}
since the mixed canonical form contains orthogonality in the left-gauged and right-gauged tensors respectively, thus simplifying the $M$ to a kronecker delta. 
...
\subsection{Density waves caused by fractional site filling}
