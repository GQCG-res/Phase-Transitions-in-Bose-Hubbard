...
\begin{center}
  ...
  \end{figure}
\end{center}
The absence of a critical point indicates that small finite models do not undergo a BKT phase transition and as such, cannot be characterized ibn the same universality class.
