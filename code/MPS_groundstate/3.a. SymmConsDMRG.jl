...
function boseHubbardHamiltonian(t::Float64, U::Float64, μ::Float64, L::Int; impurity_value::Float64=0.0, impurity_site::Int=1, periodic_boundary::Bool=true, impurity::Bool=false)
    ...
    if impurity
        H += -impurity_value, "n", impurity_site
    end
